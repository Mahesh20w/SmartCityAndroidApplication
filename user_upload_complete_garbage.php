...
$sql="UPDATE smart_city_garbage_complent SET compl_no='$v1',user_name='$v2',mobile='$v3',place_name='$v4',latitude='$v6',longitude='$v7',dept_name='$v8',dated='$v9',timed='$dated' WHERE imged='$v5'";
