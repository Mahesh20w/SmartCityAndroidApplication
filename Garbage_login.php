...
if (isset($_POST['Login'])) {
   /* if (isset($_REQUEST['redirurl']))
        ...
        $url = "index.php";
*/
    $sql = mysqli_query($conn, "select * from smart_city_garbage_login where eid='" . $_POST["Username"] . "' and password='" . $_POST["Password"] . "'");
        ...
        <div class="products-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li>Welcome to Smart City Application</li>
                </ul>
            </div>
        </div>
        <!-- //products-breadcrumb -->
...
<?php //include('navigation_bar.php');   ?>
            <div class="">
                ...
                <div class="w3_login">
                    <h3>Welcome to Smart City Application</h3>
                    <div class="w3_login_module">
                        <div class="module form-module">
                            <!---<div class="toggle"><i class="fa fa-times fa-pencil"></i>
                                <div class="tooltip">Click Me</div>
                            </div>---->
                            <a href="signup_garbage.php" style="float:right;text-decoration:underline;"></a>
                            <div class="form">
                                <h2>Garbage Department Account</h2>
