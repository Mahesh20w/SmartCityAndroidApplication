...
if (isset($_POST['Login'])) {
   /* if (isset($_REQUEST['redirurl']))
        ...
        $url = "index.php";
*/
    $sql = mysqli_query($conn, "select * from smart_city_electrical_login where eid='" . $_POST["Username"] . "' and password='" . $_POST["Password"] . "'");

    if (mysqli_num_rows($sql) > 0) {
        while ($results = mysqli_fetch_assoc($sql)) {
			$_SESSION['eid']=$results['eid'];
			...
			<script> alert('Login succesfully')
		               window.location.href='main_home_electrical.php';
		</script>
		?>
		<?php
        }
        ...
        <div class="products-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li>Welcome to Garbage Place Detection</li>
                </ul>
            </div>
        </div>
        <!-- //products-breadcrumb -->
...
<?php //include('navigation_bar.php');   ?>
            <div class="">
                ...
                <div class="w3_login">
                    <h3>Welcome to Garbage Place Detection</h3>
                    <div class="w3_login_module">
                        <div class="module form-module">
                            <!---<div class="toggle"><i class="fa fa-times fa-pencil"></i>
                                <div class="tooltip">Click Me</div>
                            </div>---->
                            <a href="signup_electrical.php" style="float:right;text-decoration:underline;"></a>
                            <div class="form">
                                <h2>Login to Electrical Department Account </h2>
                                <form action="#" method="post" name="form1">
                                    <input class="form-control" type="text" name="Username" placeholder="Enter Id " required=" ">
