...
if (isset($_POST['Login'])) {
   /* if (isset($_REQUEST['redirurl']))
        ...
        $url = "index.php";
*/
    $sql = mysqli_query($conn, "select * from smart_city_water_login where eid='" . $_POST["Username"] . "' and password='" . $_POST["Password"] . "'");
                ...
                <div class="w3_login">
                    ...
                    <div class="w3_login_module">
                        <div class="module form-module">
                            ...
                            <a href="signup_water.php" style="float:right;text-decoration:underline;"></a>
                            <div class="form">
                                <h2>Login to Water Department Account</h2>
                                <form action="#" method="post" name="form1">
                                    <input class="form-control" type="text" name="Username" placeholder="Enter Id Number" required=" ">
